<script type="text/javascript">
    $(".modal-title").text("{{ __('Add Project Equipment Category') }}");
</script>

<form action="{{ route('projectEquipmentCategories.store') }}" method="POST" enctype="multipart/form-data" id="myForm">
    @csrf
