        ...
        <div class="card">
            <div class="card-head p-3">
                <div class="align-items-center d-flex bg-white border-bottom pb-2 mb-3 main-content-card-header">
                    <h4 class="main-card-title mb-0 flex-grow-1">{{ __('Award') }}</h4>
                        ...
                        <div class="app-search">
                            <div class="input-group">
                                ...
                                <button class="btn btn-sm btn-success" type="button" id="button-addon2"
                                    ...
                                    onclick="loadModal('{{ route('awards.create') }}')"><i class="fa-regular fa-plus"></i>
                                    Add New</button>
                                @endcan
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script>
        $('#modal').on('hidden.bs.modal', function() {
            window.LaravelDataTables["award-table"];
        });
    </script>
@endpush
