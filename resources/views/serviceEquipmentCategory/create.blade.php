<script type="text/javascript">
    $(".modal-title").text("{{ __('Add Service Equipment Category') }}");
</script>

<form action="{{ route('serviceEquipmentCategories.store') }}" method="POST" enctype="multipart/form-data" id="myForm">
    @csrf
