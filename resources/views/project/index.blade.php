        ...
        <div class="card">
            <div class="card-head p-3">
                <div class="align-items-center d-flex bg-white border-bottom pb-2 mb-3 main-content-card-header">
                    <h4 class="main-card-title mb-0 flex-grow-1">{{ __('Project') }}</h4>
                    <div class="flex-shrink-0">
                        <div class="app-search">
                            <div class="input-group">
                                @can('Add Solutions')
                                <a href="{{ route('projects.create') }}" class="btn btn-sm btn-success"><i
...
@push('scripts')
    ...
    <script>
        $('#modal').on('hidden.bs.modal', function() {
            window.LaravelDataTables["project-table"];
        });
    </script>
@endpush
