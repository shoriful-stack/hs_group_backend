            ...
            <div class="col-12 col-xl-10">
                <div class="card form-card">
                    <div class="card-body px-4">
                        <form method="POST" action="{{ route('ourVisions.store') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row g-2">
                                    <div class="col-md-12">
                                        <div class="input-group-modern">
                                            ...
                                            <textarea name="contents" class="form-control" rows="4" required
                                                      placeholder="Write about this vision...">{{ old('content', $data->content ?? '') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-end gap-3 mt-4">
                                <a href="{{ route('ourVisions.index') }}" class="btn btn-outline-secondary btn-secondary text-white px-4">
