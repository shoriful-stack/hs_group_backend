        ...
        <div class="card">
            <div class="card-header">
                <div class="align-items-center d-flex bg-white border-bottom pb-2 mb-3 main-content-card-header">
                    <h4 class="main-card-title mb-0 flex-grow-1">{{ __('Pages') }}</h4>
                    <div class="flex-shrink-0">
                        <div class="app-search">
                            <div class="input-group">
                                @can('Add Pages')
                                <a class="btn btn-sm btn-success" type="button" id="button-addon2" href="{{ route('pages.create') }}">
...
@push('scripts')
    ...
    <script>
        $('#modal').on('hidden.bs.modal', function() {
            window.LaravelDataTables["page-table"];
        });
    </script>
@endpush
