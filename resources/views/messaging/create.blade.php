<script type="text/javascript">
    $(".modal-title").text("{{ __('Add Messaging Icon') }}");
    $(".modal-dialog").addClass('modal-lg');
</script>

<form action="{{ route('messagings.store') }}" method="POST" enctype="multipart/form-data" id="myForm">
    @csrf
    <div class="row">
        ...
        <div class="form-group col-md-6 mb-2">
            ...
            <div class="mt-2">
                <i id="icon-preview" class="bi bi-messenger" style="font-size: 24px;"></i>
            </div>
        </div>
